...
public class JobPositionsService {
    ...
    private Positions setJobpostioning(JobPositionsDTO positionsDTO){
        ...
        positions.setDocument_required(positionsDTO.getDocument_required());
...
//        );
    ...
    private JobPositionsDTO setJobPositionsDTO( Positions positions,
        ...
        positionsDTO.setDocument_required(positions.getDocument_required());
...
//        }
    ...
    public List<Positions> getAllByReqId(UUID requistion_id){
        return jobPositionsRepository.findAllByRequisitionId(requistion_id);
    }
}
