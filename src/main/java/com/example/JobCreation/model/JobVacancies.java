...
public class JobVacancies {
    ...
    public JobVacancies(Integer job_vacancy_id, UUID position_id, Integer special_cat_id, Integer reservation_cat_id, Long location_id, Integer no_of_vacancies) {
